...
export function initAudio(): void {
  ...
  const sfxDefinitions: Record<string, { src: string; volume: number; loop?: boolean }> = {
    ...
    uiClickAlt: { src: `/sfx/Ui%20Click%20Sound%20Effects%20Download%20SFX%20Library%20Soundsnap(1).mp3?v=${CACHE_VERSION}`, volume: 0.25 },
    ...
    enemy_card_reveal:   { src: `/sfx/enemy card reveal.mp3?v=${CACHE_VERSION}`,   volume: 0.5 },
    enemy_card_flip:     { src: `/sfx/enemy card flip in.mp3?v=${CACHE_VERSION}`,   volume: 0.4 },
    player_card_reveal:  { src: `/sfx/player card reveal hit.mp3?v=${CACHE_VERSION}`, volume: 0.5 },
    player_card_flip:    { src: `/sfx/player card flip in.mp3?v=${CACHE_VERSION}`,   volume: 0.4 },
    card_battle_music_bed: { src: `/sfx/card battle music bed.mp3?v=${CACHE_VERSION}`, volume: 0.5, loop: true },
    battle_start_horn:   { src: `/sfx/Battle start horn.mp3?v=${CACHE_VERSION}`,    volume: 0.6 },
    clash_impact:        { src: `/sfx/clash impact.mp3?v=${CACHE_VERSION}`,          volume: 0.7 },
    screen_shake:        { src: `/sfx/screen shake.mp3?v=${CACHE_VERSION}`,          volume: 0.5 },
    card_hit_damage:     { src: `/sfx/card hit damage.mp3?v=${CACHE_VERSION}`,       volume: 0.4 },
    card_hover_drone:    { src: `/sfx/card hover drone.mp3?v=${CACHE_VERSION}`,      volume: 0.15, loop: true },
    defeat_music:        { src: `/sfx/shatter defeat.mp3?v=${CACHE_VERSION}`,        volume: 0.55 },
    victory_music:       { src: `/sfx/victory 10 seconds.mp3?v=${CACHE_VERSION}`,   volume: 0.6 },
    particle_common:     { src: `/sfx/common particle.mp3?v=${CACHE_VERSION}`,       volume: 0.3 },
    particle_uncommon:   { src: `/sfx/uncommon particle.mp3?v=${CACHE_VERSION}`,     volume: 0.35 },
    particle_rare:       { src: `/sfx/rare particle.mp3?v=${CACHE_VERSION}`,         volume: 0.4 },
    particle_epic:       { src: `/sfx/epic particle burst.mp3?v=${CACHE_VERSION}`,  volume: 0.5 },
    particle_legendary:  { src: `/sfx/legendary particle reveal.mp3?v=${CACHE_VERSION}`, volume: 0.6 },
    cards_landing_in_place: { src: `/sfx/cards landing in place for battle.mp3?v=${CACHE_VERSION}`, volume: 0.6 },
    attack_swing:        { src: `/sfx/attack swing.mp3?v=${CACHE_VERSION}`,          volume: 0.45 },
    finishing_move_heavy_attack: { src: `/sfx/finishing move heavy attack.mp3?v=${CACHE_VERSION}`, volume: 0.6 },
    light_attack:        { src: `/sfx/light attack.mp3?v=${CACHE_VERSION}`,          volume: 0.4 },
    high_impact_hit:     { src: `/sfx/high impact hit.mp3?v=${CACHE_VERSION}`,       volume: 0.5 },
    light_impact_hit:    { src: `/sfx/light impact hit.mp3?v=${CACHE_VERSION}`,      volume: 0.4 },
    light_impact_hit_v2: { src: `/sfx/light impact hit v2.mp3?v=${CACHE_VERSION}`,   volume: 0.4 },
    hard_impact_critical_bone_crush: { src: `/sfx/hard impact critical bone crush.mp3?v=${CACHE_VERSION}`, volume: 0.6 },
    spell_impact:        { src: `/sfx/spell impact.mp3?v=${CACHE_VERSION}`,          volume: 0.5 },
    tiny_ice_hit:        { src: `/sfx/tiny ice hit.mp3?v=${CACHE_VERSION}`,          volume: 0.35 },
    light_earth_spell_damage: { src: `/sfx/light earth spell damage.mp3?v=${CACHE_VERSION}`, volume: 0.4 },
    heavy_defeat_message_hit: { src: `/sfx/heavy defeat message hit.mp3?v=${CACHE_VERSION}`, volume: 0.55 },
    ice_spell:           { src: `/sfx/ice spell.mp3?v=${CACHE_VERSION}`,             volume: 0.45 },
    failed_spell_hit:    { src: `/sfx/failed spell hit.mp3?v=${CACHE_VERSION}`,      volume: 0.4 },
    void_spell:          { src: `/sfx/void spell.mp3?v=${CACHE_VERSION}`,            volume: 0.5 },
    rife_spell:          { src: `/sfx/rife spell.mp3?v=${CACHE_VERSION}`,            volume: 0.5 },
    kalgoth_defeats_you: { src: `/sfx/Kalgoth defeats you.mp3?v=${CACHE_VERSION}`,  volume: 0.6 },
    victory_hit_message_particle_burst: { src: `/sfx/vicrory hit message particle burst.mp3?v=${CACHE_VERSION}`, volume: 0.6 },
    card_attack_heavy_slash: { src: `/sfx/card attack heavy slash.mp3?v=${CACHE_VERSION}`, volume: 0.5 },
    defeat:              { src: `/sfx/defeat.mp3?v=${CACHE_VERSION}`,                volume: 0.5 },
    victory_10_seconds:  { src: `/sfx/victory 10 seconds.mp3?v=${CACHE_VERSION}`,   volume: 0.6 },

    // Duell / Choice
    duel_start: { src: `/sfx/duel_start.mp3?v=${CACHE_VERSION}`, volume: 0.5 },
    duel_success: { src: `/sfx/duel_success.mp3?v=${CACHE_VERSION}`, volume: 0.5 },
