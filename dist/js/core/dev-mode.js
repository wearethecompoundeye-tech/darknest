...
import { ingredients, crafted, knownRunes, selectedRunes, runeSlots, will, health, maxWill, suspicion, seedResonance, maxSeedResonance, orbexFragments, maxOrbexFragments, corruptionLevel, kalgothsNoose, circlePower, circleMastery, gazeIntensity, wardIntegrities, tutorial, discoveries, ownedCards, equippedEntitySlots, equippedSpellSlots, equippedEnhancementSlots, equippedLandSlots, ownedRelics, equippedRelics, mazePathsUnlocked, timerSeconds, gazePhase, isGazeActive, gazeSurvivalCount, dailyConsumableSlots, itemUsageDaily, activeDemon, } from './state-signals.js';
...
export function grantAllResources() {
    batch(() => {
        // Infinite resources
        ingredients.value = {
            nightshadeMoss: 999,
