...
export const allCards = [
    ...
    },
    {
        ...
        stats: { effect: '+2 maximum Will.', statBonus: { maxWill: 2 } }
    },
    {
        ...
        stats: { effect: '+1 HP for all Water entities.', aspectBonus: { Water: { hp: 1 } } }
    },
    {
        ...
        stats: { effect: 'Entities have +1 CUN when detecting Traps.', statBonus: { cun: 1 } }
    },
    {
    ...
    // --- Uncommon Enhancements (5) ---
    {
        ...
        stats: { effect: '+1 CUN for all Void entities.', aspectBonus: { Void: { cun: 1 } } }
    },
    {
    ...
    },
    {
        ...
        stats: { effect: '+1 SPD for all entities.', statBonus: { spd: 1 } }
    },
    {
    ...
    },
    {
        ...
        stats: { effect: '+5 maximum Will; +1 Will regeneration per day.', statBonus: { maxWill: 5 } }
    },
    // --- Epic Enhancements (3) ---
    {
    ...
    },
    {
        ...
        stats: { effect: 'All entities gain +1 to all stats (HP, ATK, SPD, CUN).', statBonus: { hp: 1, atk: 1, spd: 1, cun: 1 } }
    },
    {
    ...
    // --- Uncommon Lands (4) ---
    {
        ...
        stats: { effect: 'Fire entities gain +1 ATK while on expedition.', expeditionBonus: { atk: 1 } }
    },
    {
    ...
    },
    {
        ...
        stats: { effect: 'All entities gain +1 CUN while exploring.', expeditionBonus: { cun: 1 } }
    },
    {
    ...
    },
    {
        ...
        stats: { effect: 'Death entities have +2 HP.', expeditionBonus: { hp: 2 } }
    },
    {
        ...
        stats: { effect: 'Air entities have +2 SPD.', expeditionBonus: { spd: 2 } }
    },
    {
    ...
    // --- Legendary Lands (2) ---
    {
        ...
        stats: { effect: 'All Spell costs reduced by 1 (minimum 1). +3 CUN for all entities.', expeditionBonus: { cun: 3 } }
    },
    {
...
export function getCardsByAspect(aspect) {
