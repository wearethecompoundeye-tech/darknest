...
export function forage() {
    ...
    batch(() => {
        ...
        const items = ["nightshadeMoss", "cryptPhlegm", "bansheeSalts"];
        const weights = [0.5, 0.35, 0.15];
        const random = Math.random();
        let cum = 0;
        let reward = 'nightshadeMoss';
...
export function applyWhispDailyUpkeep() {
