...
export const DEFAULT_ENTITY_CARD: Card = {
  ...
  rarity: 'common',
  aspect: 'Void',
  image: `${import.meta.env.BASE_URL}Images/Game Art/Creatures/Umbral Mite.png`,
  frame: `${import.meta.env.BASE_URL}Images/Game Art/Frame Overlays/Common Frame.png`,
