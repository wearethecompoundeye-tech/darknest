...
export function talkToDemon(): void {
...
function getContextualSituation(): string {
  const parts: string[] = [];
...
function getFallbackDialogue(trait: string): string {
...
function createDemonDialogueModal(demonName: string, demonTrait: string): HTMLDivElement {
...
export function openDemonModal(): void {
  talkToDemon();
}