...
function renderGuidanceTab(): string {
  return `
    <h4>🧭 Guidance</h4>
...
function renderEntitiesTab(): string {
  return `
...
function renderIngredientsTab(): string {
...
function renderRitualsTab(): string {
  return `
    <h4>🔮 Rituals</h4>
...
function renderRelicsTab(): string {
